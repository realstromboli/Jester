...
public class MusicController : MonoBehaviour
{
    ...
    void OnSceneLoaded(/*UnityEngine.SceneManagement.*/Scene scene, LoadSceneMode mode)
    {
        ...
        else if (SceneManager.GetActiveScene().name == "Inside Trailer" || SceneManager.GetActiveScene().name == "Indoor Circus" || SceneManager.GetActiveScene().name == "3INDOORCIRC" || SceneManager.GetActiveScene().name == "2Inside Trailer" || SceneManager.GetActiveScene().name == "2FINISHInside Trailer")
        {
